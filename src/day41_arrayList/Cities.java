...
//int all values in same line
        ...
        System.out.println("countof items = " + cities.size());
        ...
        System.out.println();
        //delite item from arraylist
        //1)remove using index. delite value at index 3
        cities.remove(3);
        ...
        //delite/remove all values from list
        cities.clear();
